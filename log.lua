...
do 
    ...
    -- miracle_debug("Delay" .. " : " .. miracle_cfg.Delay)
    -- miracle_debug("Team" .. " : " .. miracle_cfg.Team)
    -- miracle_debug("Distance" .. " : " .. miracle_cfg.Distance)
    -- miracle_debug("LowHop" .. " : " .. miracle_cfg.LowHop)
    -- miracle_debug("CooldownHop" .. " : " .. miracle_cfg.CooldownHop)
    -- miracle_debug("HopNear" .. " : " .. miracle_cfg.HopNear)
    -- miracle_debug("TimeAFK" .. " : " .. miracle_cfg.TimeAFK)
    -- miracle_debug("FilterItem" .. " : " .. miracle_cfg.FilterItem)
    -- miracle_debug("ShowOnlyCDK" .. " : " .. miracle_cfg.ShowOnlyCDK)
    -- miracle_debug("Lengened" .. " : " .. miracle_cfg.Lengened)
    -- miracle_debug("SheetType" .. " : " .. miracle_cfg.SheetType)
